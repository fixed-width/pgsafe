...
- New rule `add-domain-not-null` (Error): flags `ALTER DOMAIN … ADD NOT NULL`, which scans and write-locks every dependent table and (unlike a CHECK) cannot be added `NOT VALID` (#95).
